...
#
#     PHX_SERVER=true bin/devfinder start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :devfinder, DevfinderWeb.Endpoint, server: true
end

if config_env() == :prod do
  database_url = "postgres://postgres:WM0iYoZlVHee6lG@optimum-preview-apps-db.flycast:5432"
  ...
  #
  #     config :devfinder, Devfinder.Mailer,
